...
const styles = StyleSheet.create({
  ...
  status: { fontFamily: fonts.bodyRegular, fontSize: fontSize.base, color: colors.inkSecondary, textAlign: "center" },
  statusSub: { fontFamily: fonts.bodyRegular, fontSize: fontSize.sm, color: colors.inkMuted },
  skeletonWrap: { gap: 14 },
  ...
  headline: { fontSize: fontSize.lg, fontFamily: fonts.bodyBold, color: colors.ink, marginTop: -spacing.md },
  ...
  paragraph: { fontFamily: fonts.bodyRegular, fontSize: fontSize.base, lineHeight: fontSize.base * 1.75, color: colors.ink },
